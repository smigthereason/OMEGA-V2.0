        ...
        <div className="w-1/2">
          <div className="overflow-hidden h-40">
            <Splide className="splide">
              <SplideSlide><img src={SponsorLogo1} alt="Sponsor Logo 1" className="h-16 mr-4" /></SplideSlide>
              <SplideSlide><img src={SponsorLogo2} alt="Sponsor Logo 2" className="h-16 mr-4" /></SplideSlide>
              <SplideSlide><img src={SponsorLogo3} alt="Sponsor Logo 3" className="h-16 mr-4" /></SplideSlide>
              <SplideSlide><img src={SponsorLogo4} alt="Sponsor Logo 4" className="h-16 mr-4" /></SplideSlide>
              {/* Add more sponsor logos here */}
            </Splide>
          </div>
        </div>
